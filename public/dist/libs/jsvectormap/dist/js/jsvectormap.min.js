      ...
      (s.updateLabelPosition = function () {
        this.label &&
          this.label.set({
            ...
            y:
              this._labelY * this._map.scale + this._map.transY * this._map.scale + this._offsets[1]
          });
      }),
    ...
    Y = (function () {
      function t(t, e, i) {
        void 0 === t && (t = {}),
          ...
          this.config.legend &&
            (this.legend = new A(v({ map: this._map, series: this }, this.config.legend))),
  ...
  var T = {
            ...
            ? ((o = this.scale),
              ...
              (r = setInterval(function () {
                (g += 1),
                  ...
                  m._applyTransform(),
                  g == v &&
                    (clearInterval(r), m._emit(k.onViewportChange, [m.scale, m.transX, m.transY]));
              }, 10)))
            : ((this.transX = d),
              (this.transY = f),
              (this.scale = t),
      ...
      return (
        ...
        (s.updateStyle = function () {
          ...
          v(t, this.style.initial),
            ...
            this.isSelected &&
              (v(t, this.style.selected), this.isHovered && v(t, this.style.selectedHover)),
            this.set(t);
        }),
        i
      );
    ...
    G = (function () {
      function t(e) {
        var i = this;
        if (
          (void 0 === e && (e = {}), (this.params = v(t.defaults, e, !0)), !t.maps[this.params.map])
        )
          ...
          (this.container = f(t.selector)),
            ...
            t.series &&
              (this.container.appendChild(
                (this.legendHorizontal = m('div', 'jvm-series-container jvm-series-h'))
              ),
              this.container.appendChild(
                (this.legendVertical = m('div', 'jvm-series-container jvm-series-v'))
              ),
              this._createSeries()),
