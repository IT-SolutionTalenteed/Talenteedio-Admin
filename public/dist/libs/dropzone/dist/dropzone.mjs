...
class $3ed269f2f0fb224b$export$2e2bcd8739ae039 extends $4040acfd8584338d$export$2e2bcd8739ae039 {
  ...
  paste(e) {
    if (
      $3ed269f2f0fb224b$var$__guard__(e != null ? e.clipboardData : undefined, (x) => x.items) ==
      null
    )
      return;
    this.emit('paste', e);
  ...
  _addFilesFromDirectory(directory, path) {
    ...
    let errorHandler = (error) =>
      $3ed269f2f0fb224b$var$__guardMethod__(console, 'log', (o) => o.log(error));
    var readEntries = () => {
  ...
  accept(file, done) {
    if (this.options.maxFilesize && file.size > this.options.maxFilesize * 1048576)
      ...
      !$3ed269f2f0fb224b$export$2e2bcd8739ae039.isValidFile(file, this.options.acceptedFiles)
    )
    ...
    this._transformFiles(files, (transformedFiles) => {
      ...
      if (files[0].upload.chunked) {
        ...
        if (this.options.parallelChunkUploads)
          for (let i = 0; i < file.upload.totalChunkCount; i++) handleNextChunk();
  ...
  constructor(el, options) {
    ...
    let elementOptions =
      (left = $3ed269f2f0fb224b$export$2e2bcd8739ae039.optionsForElement(this.element)) != null
        ? left
        : {};
