...
var $b657c03155fc27e2$var$defaultOptions = {
  ...
  addedfile: function (file) {
    ...
    if (this.previewsContainer && !this.options.disablePreviews) {
      var _this = this;
      file.previewElement = $a601ff30f483e917$export$2e2bcd8739ae039.createElement(
      ...
      try {
        for (
          var _iterator = file.previewElement.querySelectorAll('[data-dz-name]')[Symbol.iterator](),
            _step;
          !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
          _iteratorNormalCompletion = true
        ) {
...
var $a601ff30f483e917$export$2e2bcd8739ae039 = /*#__PURE__*/ (function (Emitter) {
  ...
  function $a601ff30f483e917$export$2e2bcd8739ae039(el, options) {
    ...
    var elementOptions =
      (left = $a601ff30f483e917$export$2e2bcd8739ae039.optionsForElement(_this.element)) != null
        ? left
        : {};
    ...
    if (_this.options.previewsContainer !== false) {
      if (_this.options.previewsContainer)
        _this.previewsContainer = $a601ff30f483e917$export$2e2bcd8739ae039.getElement(
    ...
    if (_this.options.clickable) {
      if (_this.options.clickable === true) _this.clickableElements = [_this.element];
        ...
        _this.clickableElements = $a601ff30f483e917$export$2e2bcd8739ae039.getElements(
                  ...
                  for (
                    ...
                    if (entry.isFile)
                      entry.file(function (file) {
                        if (_this2.options.ignoreHiddenFiles && file.name.substring(0, 1) === '.')
                          return;
                        file.fullPath = ''.concat(path, '/').concat(file.name);
                        return _this2.addFile(file);
                      });
                    else if (entry.isDirectory)
                      _this1._addFilesFromDirectory(entry, ''.concat(path, '/').concat(entry.name));
                  }
                } catch (err) {
                  _didIteratorError = true;
                  _iteratorError = err;
      ...
      },
      {
        ...
        value: function accept(file, done) {
          if (this.options.maxFilesize && file.size > this.options.maxFilesize * 1048576)
            ...
            !$a601ff30f483e917$export$2e2bcd8739ae039.isValidFile(file, this.options.acceptedFiles)
          )
          ...
          return this.createThumbnail(
            ...
            function (dataUrl, canvas) {
              if (canvas == null)
                ...
                return callback(
                  $a601ff30f483e917$export$2e2bcd8739ae039.dataURItoBlob(resizedDataURL)
                );
              }
            }
          );
          ...
          this._transformFiles(files, function (transformedFiles) {
            if (_this.options.chunking) {
              ...
              files[0].upload.chunked =
                ...
                (_this.options.forceChunking || transformedFile.size > _this.options.chunkSize);
        ...
        value: function _uploadData(files, dataBlocks) {
          ...
          xhr.ontimeout = function () {
            _this7._handleUploadError(
              files,
              xhr,
              'Request timedout after '.concat(_this7.options.timeout / 1000, ' seconds')
            );
          };
          ...
          if (this.options.headers)
            $parcel$interopDefault($6mU8w$justextend)(headers, this.options.headers);
  ...
  if (
    ...
    if (!('classList' in document.createElement('a'))) capableBrowser = false;
      ...
      try {
        ...
        for (
          var _iterator =
              $a601ff30f483e917$export$2e2bcd8739ae039.blockedBrowsers[Symbol.iterator](),
            _step;
          !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
          _iteratorNormalCompletion = true
        ) {
...
var $a601ff30f483e917$var$drawImageIOSFix = function $a601ff30f483e917$var$drawImageIOSFix(
  ctx,
  img,
  sx,
  sy,
