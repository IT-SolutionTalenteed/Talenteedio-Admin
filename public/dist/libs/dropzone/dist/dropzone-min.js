  ...
  var p = {
      ...
      addedfile: function (e) {
        if (
          ...
          try {
            for (
              var g, b = e.previewElement.querySelectorAll('[data-dz-remove]')[Symbol.iterator]();
              !(m = (g = b.next()).done);
              m = !0
            ) {
      ...
      error: function (e, t) {
        if (e.previewElement) {
          ...
          try {
            for (
              var a,
                o = e.previewElement.querySelectorAll('[data-dz-errormessage]')[Symbol.iterator]();
              !(i = (a = o.next()).done);
              i = !0
            ) {
                            ...
                            u.isFile
                              ? u.file(function (e) {
                                  if (
                                    ...
                                    return (
                                      (e.fullPath = ''.concat(t, '/').concat(e.name)), c.addFile(e)
                                    );
                                })
                              : u.isDirectory &&
