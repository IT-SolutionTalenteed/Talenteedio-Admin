            ...
            (this.remove = function (t, e, r) {
              for (var n = 0, s = 0, i = v.items.length; s < i; s++)
                v.items[s].values()[t] == e &&
                  (v.templater.remove(v.items[s], r), v.items.splice(s, 1), i--, s--, n++);
              return v.update(), n;
            }),
              ...
              for (var g = 1; g <= c; g++) {
                ...
                a.number(g, d, v, f, h)
                  ...
                  : a.dotted(r, g, d, v, f, h, r.size()) &&
                    ((i = r.add({ page: '...', dotted: !0 })[0]), n(i.elm).add('disabled'));
              }
            },
            a = {
            ...
            s = {
              ...
              setColumns: function () {
                0 !== t.items.length &&
                  void 0 === e &&
                  (e =
                    void 0 === t.searchColumns ? s.toArray(t.items[0].values()) : t.searchColumns);
              },
            ...
            for (var b = y; b >= p; b--) {
              ...
              if (
                ((C[b] =
                  0 === m
                    ? ((C[b + 1] << 1) | 1) & j
                    : (((C[b + 1] << 1) | 1) & j) | ((v[b + 1] | v[b]) << 1) | 1 | v[b + 1]),
                C[b] & d)
              ) {
                var x = l(m, b - 1);
                if (x <= u) {
