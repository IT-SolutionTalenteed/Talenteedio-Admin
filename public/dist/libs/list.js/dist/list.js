        ...
        module.exports = function (id, options, values) {
          ...
          init = {
            start: function start() {
              ...
              self.fuzzySearch = __webpack_require__(/*! ./fuzzy-search */ './src/fuzzy-search.js')(
                self,
                options.fuzzySearch
              );
              this.handlers();
          ...
          var refresh = function refresh(pagingList, options) {
            ...
            for (var i = 1; i <= pages; i++) {
              ...
              if (is.number(i, left, right, currentPage, innerWindow)) {
                ...
                is.dotted(pagingList, i, left, right, currentPage, innerWindow, pagingList.size())
              ) {
                item = pagingList.add({
                  page: '...',
                  dotted: true
          ...
          var sort = function sort() {
            ...
            if (customSortFunction) {
              ...
              sortFunction = function sortFunction(itemA, itemB) {
                ...
                return (
                  sort(itemA.values()[options.valueName], itemB.values()[options.valueName]) * multi
                );
              };
            }
