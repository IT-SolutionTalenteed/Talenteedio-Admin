    ...
    var n = (function () {
      ...
      return (
        (t.parseDateTime = function (e, i, n) {
          if ((void 0 === i && (i = 'YYYY-MM-DD'), void 0 === n && (n = 'en-US'), !e))
            return new Date(NaN);
                ...
                if (
                  ...
                  var p = this.pluralSelector(h),
                    d =
                      h +
                      ' ' +
                      (this.options.tooltipText[p] ? this.options.tooltipText[p] : '[' + p + ']');
      ...
      c = (function (t) {
        function e(e) {
          ...
          i.options.startDate &&
            ...
            c &&
              i.options.endDate &&
              (h = new a.DateTime(i.options.endDate, i.options.format, i.options.lang)),
      ...
      return (
        ...
        (e.i = function (t, i, n) {
          ...
          for (var a = 0; a < t.length; a++) {
            var l = [].concat(t[a]);
            (n && o[l[0]]) ||
              (i && (l[2] ? (l[2] = ''.concat(i, ' and ').concat(l[2])) : (l[2] = i)), e.push(l));
          }
        }),
        e
      );
    ...
    (s.Litepicker.prototype.show = function (t) {
      ...
      (s.Litepicker.prototype.setDateRange = function (t, e, i) {
        ...
        (this.options.disallowLockDaysInRange
          ...
          : r.dateIsLocked(n, this.options, [n, s]) || r.dateIsLocked(s, this.options, [n, s])) &&
        !i
            ...
            o
              ...
              : (function (t) {
                  var n = e.ui.querySelector(
                    ''.concat(
                      { ArrowLeft: '.button-previous-month', ArrowRight: '.button-next-month' }[
                        t.code
                      ],
                      '[tabindex="1"]'
                    )
        ...
        function i(t) {
          e.isMouseDown
            ...
            : this.options.inlineMode ||
              ...
              (this.show(t.target),
              this.ui
                .querySelector('[tabindex="'.concat(e.options.keyboardnav.firstTabIndex, '"]'))
                .focus());
        }
        function a(e) {
          var t = this;
