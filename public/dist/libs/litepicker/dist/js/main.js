      ...
      var o = (function () {
        ...
        return (
          (t.parseDateTime = function (e, i, o) {
            if ((void 0 === i && (i = 'YYYY-MM-DD'), void 0 === o && (o = 'en-US'), !e))
              return new Date(NaN);
        ...
        h = (function (t) {
          function e(e) {
            ...
            i.options.startDate &&
              ...
              p &&
                i.options.endDate &&
                (c = new l.DateTime(i.options.endDate, i.options.format, i.options.lang)),
          ...
          return (
                  ...
                  if (i.classList.contains(p.dayItem)) {
                    ...
                    if (this.shouldCheckLockDays()) {
                      ...
                      this.options.lockDays.filter(function (t) {
                        return t instanceof Array
                          ? t[0].isBetween(e.datePicked[0], e.datePicked[1], n) ||
                              t[1].isBetween(e.datePicked[0], e.datePicked[1], n)
                    ...
                    if (this.shouldCheckBookedDays()) {
                      ...
                      var r = this.options.bookedDays.filter(function (t) {
                          return t instanceof Array
                            ? t[0].isBetween(e.datePicked[0], e.datePicked[1], s) ||
                                t[1].isBetween(e.datePicked[0], e.datePicked[1], s)
                  ...
                  if (i.classList.contains(p.buttonPreviousMonth)) {
                    ...
                    return (
                      ...
                      void (
                        ...
                        this.options.onChangeMonth.call(this, this.calendars[h], h)
                      )
                    );
                  }
            ...
            (e.prototype.shouldAllowMouseEnter = function (t) {
              return (
                !this.options.singleMode &&
                !t.classList.contains(p.isLocked) &&
                !t.classList.contains(p.isBooked)
              );
            }),
            ...
            (e.prototype.onMouseEnter = function (t) {
              ...
              if (
                ...
                var o = this.picker.querySelector(
                    '.' + p.dayItem + '[data-time="' + this.datePicked[0].getTime() + '"]'
                  ),
                ...
                if (
                  (Array.prototype.slice
                    .call(this.picker.querySelectorAll('.' + p.dayItem))
                    .forEach(function (t) {
                      var i = new l.DateTime(t.dataset.time),
                        o = e.renderDay(i);
                      i.isBetween(n, s) && o.classList.add(p.isInRange),
                  ...
                  if ((this.options.hotelMode || (c += 1), c > 0)) {
                    var h = this.pluralSelector(c),
                      d =
                        c +
                        ' ' +
                        (this.options.tooltipText[h] ? this.options.tooltipText[h] : '[' + h + ']');
            ...
            (e.prototype.onInput = function (t) {
              ...
              if (
                this.options.elementEnd
                  ...
                  : i instanceof l.DateTime &&
                    o instanceof l.DateTime &&
                    '' + i.format(n) + this.options.delimiter + o.format(n) ===
                      this.options.element.value
              ) {
          ...
          return (
            (t.prototype.render = function () {
              ...
              for (
                var o = this.calendars[0].clone(),
                  n = o.getMonth(),
                  r = o.getMonth() + this.options.numberOfMonths,
                  a = 0,
                  l = n;
                l < r;
                l += 1
            ...
            (t.prototype.renderMonth = function (t) {
                  ...
                  (d.value = String(h)),
                    ...
                    (d.disabled =
                      (this.options.minDate &&
                        u.isBefore(new n.DateTime(this.options.minDate), 'month')) ||
                      (this.options.maxDate &&
                        u.isAfter(new n.DateTime(this.options.maxDate), 'month'))),
                ...
                c.addEventListener('change', function (t) {
                  ...
                  e.calendars[o].setMonth(Number(i.value)),
                    ...
                    'function' == typeof e.options.onChangeMonth &&
                      e.options.onChangeMonth.call(e, e.calendars[o], o);
                }),
                  p.appendChild(c);
              } else {
              ...
              if (this.options.dropdowns.years) {
                ...
                for (h = y; h >= g; h -= 1) {
                  ...
                  (d.value = h),
                    ...
                    (d.disabled =
                      (this.options.minDate &&
                        k.isBefore(new n.DateTime(this.options.minDate), 'year')) ||
                      (this.options.maxDate &&
                        k.isAfter(new n.DateTime(this.options.maxDate), 'year'))),
                ...
                f.addEventListener('change', function (t) {
                  ...
                  e.calendars[o].setFullYear(Number(i.value)),
                    ...
                    'function' == typeof e.options.onChangeYear &&
                      e.options.onChangeYear.call(e, e.calendars[o], o);
                }),
                  p.appendChild(f);
              } else {
                var D = document.createElement('span');
                (D.className = s.monthItemYear),
                  (D.innerHTML = String(t.getFullYear())),
                  p.appendChild(D);
              }
              var b = document.createElement('a');
              (b.href = '#'),
                (b.className = s.buttonPreviousMonth),
              ...
              (w.href = '#'),
                ...
                this.options.maxDate &&
                  i.isSameOrAfter(new n.DateTime(this.options.maxDate), 'month') &&
                  a.classList.add(s.noNextMonth);
              var M = document.createElement('div');
              (M.className = s.monthItemWeekdaysRow),
                this.options.showWeekNumbers && (M.innerHTML = '<div>W</div>');
              for (var x = 1; x <= 7; x += 1) {
                var T = 3 + this.options.firstDay + x,
                  _ = document.createElement('div');
                (_.innerHTML = this.weekdayName(T)),
                  (_.title = this.weekdayName(T, 'long')),
                  M.appendChild(_);
              }
              var L = document.createElement('div');
              ...
              for (E = 1; E <= o; E += 1)
                i.setDate(E),
                  this.options.showWeekNumbers &&
                    ...
                    L.appendChild(this.renderWeekNumber(i)),
            ...
            (t.prototype.renderDay = function (t) {
                ...
                this.datePicked.length
                  ...
                  : this.options.startDate &&
                    (this.options.startDate.toDateString() === t.toDateString() &&
                      ...
                      this.options.singleMode && i.classList.add(s.isEndDate)),
                    this.options.endDate &&
                      this.options.endDate.toDateString() === t.toDateString() &&
                      i.classList.add(s.isEndDate),
                    this.options.startDate &&
                      this.options.endDate &&
                      ...
                      i.classList.add(s.isInRange)),
                this.options.minDate &&
                  t.isBefore(new n.DateTime(this.options.minDate)) &&
                  i.classList.add(s.isLocked),
                this.options.maxDate &&
                  t.isAfter(new n.DateTime(this.options.maxDate)) &&
                  i.classList.add(s.isLocked),
              ...
              if (this.options.maxDays && 1 === this.datePicked.length) {
                ...
                t.isSameOrBefore(r) && i.classList.add(s.isLocked),
                  t.isSameOrAfter(a) && i.classList.add(s.isLocked);
              }
            ...
            (t.prototype.renderFooter = function () {
              ...
              if (
                ...
                (1 === this.datePicked.length &&
                  t.querySelector('.' + s.buttonApply).setAttribute('disabled', ''),
                2 === this.datePicked.length)
              ) {
        ...
        return (
          ...
          (e.i = function (t, i) {
            ...
            for (var r = 0; r < t.length; r++) {
              var a = t[r];
              (null != a[0] && o[a[0]]) ||
                (i && !a[2] ? (a[2] = i) : i && (a[2] = '('.concat(a[2], ') and (').concat(i, ')')),
                e.push(a));
            }
          }),
          e
    ...
    function (t, e, i) {
      ...
      (r.Litepicker.prototype.show = function (t) {
        ...
        if (this.options.parentEl) {
          ...
          (p -= f.bottom),
            (p += s.height) + r.height > window.innerHeight &&
              s.top - f.top - s.height > 0 &&
              (u = s.top - f.top - s.height),
            (c -= f.left) + r.width > window.innerWidth &&
              s.right - f.right - r.width > 0 &&
              (m = s.right - f.right - r.width);
        } else
        ...
        (r.Litepicker.prototype.setOptions = function (t) {
          delete t.element,
            ...
            delete t.parentEl,
            t.startDate &&
              (t.startDate = new s.DateTime(t.startDate, this.options.format, this.options.lang)),
            t.endDate &&
              (t.endDate = new s.DateTime(t.endDate, this.options.format, this.options.lang));
        ...
        (r.Litepicker.prototype.destroy = function () {
          this.picker &&
            ...
            (this.picker.parentNode.removeChild(this.picker), (this.picker = null)),
            this.backdrop &&
