    ...
    var i = (function () {
      ...
      return (
        (t.parseDateTime = function (e, n, i) {
          if ((void 0 === n && (n = 'YYYY-MM-DD'), void 0 === i && (i = 'en-US'), !e))
            return new Date(NaN);
        ...
        (t.prototype.format = function (e, n) {
          if ((void 0 === n && (n = 'en-US'), 'object' == typeof e))
            ...
            if (this.options.scrollToDate) {
              var e =
                  this.options.startDate instanceof a.DateTime
                    ...
                    : null,
                n =
                  this.options.endDate instanceof a.DateTime ? this.options.endDate.clone() : null;
              !this.options.startDate || (t && t !== this.options.element)
                ? t &&
                  ...
                  this.options.numberOfMonths > 1 &&
                    n.isAfter(e) &&
                    n.setMonth(n.getMonth() - (this.options.numberOfMonths - 1)),
              ...
              if (this.shouldShown(e)) this.show(e);
                ...
                if (this.isSamePicker(e))
                  if ((this.emit('before:click', e), this.preventClick)) this.preventClick = !1;
                    ...
                    e.classList.contains(h.buttonCancel) &&
          ...
          (e.prototype.onMouseEnter = function (t) {
            ...
            if (this.isDayItem(n) && this.shouldAllowMouseEnter(n)) {
              if (
                ...
                return;
              var i = this.ui.querySelector(
                  '.' + h.dayItem + '[data-time="' + this.datePicked[0].getTime() + '"]'
                ),
              ...
              if (
                (Array.prototype.slice
                  .call(this.ui.querySelectorAll('.' + h.dayItem))
                  .forEach(function (t) {
                ...
                if (
                  ...
                  var c = this.pluralSelector(p),
                    d =
                      p +
                      ' ' +
                      (this.options.tooltipText[c] ? this.options.tooltipText[c] : '[' + c + ']');
          ...
          (e.prototype.onInput = function (t) {
            ...
            if (
              this.options.elementEnd
                ...
                : n instanceof a.DateTime &&
                  i instanceof a.DateTime &&
                  '' + n.format(o) + this.options.delimiter + i.format(o) ===
                    this.options.element.value
            ) {
    ...
    Object.defineProperty(e, '__esModule', { value: !0 }),
          ...
          e.lockDays.length &&
            (i = e.lockDays.filter(function (n) {
              return n instanceof Array
                ? t.isBetween(n[0], n[1], e.lockDaysInclusivity)
                : n.isSame(t, 'day');
            }).length),
          i ||
            'function' != typeof e.lockDaysFilter ||
            (i = e.lockDaysFilter.call(this, t.clone(), null, n)),
          i
        );
      }),
      (e.rangeIsLocked = function (t, e) {
        ...
        return (
          e.lockDays.length &&
            (n = e.lockDays.filter(function (n) {
              if (n instanceof Array) {
                var i =
                  t[0].toDateString() === n[0].toDateString() &&
                  t[1].toDateString() === n[1].toDateString();
                return (
                  n[0].isBetween(t[0], t[1], e.lockDaysInclusivity) ||
                  n[1].isBetween(t[0], t[1], e.lockDaysInclusivity) ||
                  i
                );
              }
          ...
          n ||
            'function' != typeof e.lockDaysFilter ||
            (n = e.lockDaysFilter.call(this, t[0].clone(), t[1].clone(), t)),
          n
        );
      });
  },
        ...
        return (
          ...
          (e.prototype.render = function () {
            ...
            (n.className = a.containerMonths),
              a['columns' + this.options.numberOfColumns] &&
                (n.classList.remove(a.columns2, a.columns3, a.columns4),
            ...
            for (
              var i = this.calendars[0].clone(),
                o = i.getMonth(),
                s = i.getMonth() + this.options.numberOfMonths,
                r = 0,
                h = o;
              h < s;
              h += 1
          ...
          (e.prototype.renderMonth = function (t, e) {
            ...
            if (this.options.dropdowns.years) {
              ...
              for (d = v; d >= y; d -= 1) {
                ...
                (u.value = String(d)),
                  ...
                  (u.disabled =
                    (this.options.minDate &&
                      D.isBefore(new r.DateTime(this.options.minDate), 'year')) ||
                    (this.options.maxDate &&
                      D.isAfter(new r.DateTime(this.options.maxDate), 'year'))),
              ...
              (M.className = a.monthItemYear),
                (M.innerHTML = String(t.getFullYear())),
                p.appendChild(M);
            }
            var T = document.createElement('button');
            (T.type = 'button'),
              (T.className = a.buttonPreviousMonth),
              (T.innerHTML = this.options.buttonText.previousMonth);
            ...
            (k.type = 'button'),
              ...
              this.options.maxDate &&
                i.isSameOrAfter(new r.DateTime(this.options.maxDate), 'month') &&
                s.classList.add(a.noNextMonth);
            var b = document.createElement('div');
            (b.className = a.monthItemWeekdaysRow),
              this.options.showWeekNumbers && (b.innerHTML = '<div>W</div>');
            for (var L = 1; L <= 7; L += 1) {
              var E = 3 + this.options.firstDay + L,
                S = document.createElement('div');
              (S.innerHTML = this.weekdayName(E)),
                (S.title = this.weekdayName(E, 'long')),
                b.appendChild(S);
            }
            var P = document.createElement('div');
            ...
            for (x = 1; x <= o; x += 1)
              i.setDate(x),
                this.options.showWeekNumbers &&
                  ...
                  P.appendChild(this.renderWeekNumber(i)),
          ...
          (e.prototype.renderDay = function (t) {
            ...
            if (this.options.maxDays && 1 === this.datePicked.length) {
              ...
              (s = this.datePicked[0].clone().subtract(p, 'day')),
                (l = this.datePicked[0].clone().add(p, 'day'));
              t.isSameOrBefore(s) && e.classList.add(a.isLocked),
                t.isSameOrAfter(l) && e.classList.add(a.isLocked);
            }
          ...
          (e.prototype.weekdayName = function (t, e) {
            return (
              void 0 === e && (e = 'short'),
              new Date(1970, 0, t, 12, 0, 0, 0).toLocaleString(this.options.lang, { weekday: e })
            );
          }),
        ...
        function e(e) {
          ...
          (n.options = s(s({}, n.options), e)),
            ...
            n.options.lockDays.length &&
              (n.options.lockDays = a.DateTime.convertArray(
                n.options.lockDays,
                n.options.lockDaysFormat
              )),
            n.options.highlightedDays.length &&
              (n.options.highlightedDays = a.DateTime.convertArray(
          ...
          n.options.startDate &&
            ...
            l &&
              n.options.endDate &&
              (p = new a.DateTime(n.options.endDate, n.options.format, n.options.lang)),
            l instanceof a.DateTime && !isNaN(l.getTime()) && (n.options.startDate = l),
            n.options.startDate &&
              p instanceof a.DateTime &&
              !isNaN(p.getTime()) &&
              (n.options.endDate = p),
            !n.options.singleMode ||
              n.options.startDate instanceof a.DateTime ||
        ...
        return (
          ...
          (e.prototype.parseInput = function () {
            ...
            if (this.options.elementEnd) {
              ...
              return [
                new a.DateTime(i, this.options.format),
          ...
          (e.prototype.findPosition = function (t) {
            ...
            if (/left|right/.test(i[0]) || (i[1] && 'auto' !== i[1] && /left|right/.test(i[1])))
              (a = /left|right/.test(i[0]) ? e[i[0]] + o : e[i[1]] + o),
      ...
      if (
        (void 0 === (s = t._events)
          ...
          : (void 0 !== s.newListener &&
              (t.emit('newListener', e, n.listener ? n.listener : n), (s = t._events)),
            (r = s[e])),
        void 0 === r)
      )
    ...
    (s.Litepicker.prototype.show = function (t) {
      ...
      (s.Litepicker.prototype.setDateRange = function (t, e, n) {
        ...
        (this.options.disallowLockDaysInRange
          ...
          : r.dateIsLocked(i, this.options, [i, s]) || r.dateIsLocked(s, this.options, [i, s])) &&
        !n
      ...
      (s.Litepicker.prototype.setOptions = function (t) {
        delete t.element,
          ...
          delete t.parentEl,
          t.startDate &&
            (t.startDate = new o.DateTime(t.startDate, this.options.format, this.options.lang)),
          t.endDate &&
            (t.endDate = new o.DateTime(t.endDate, this.options.format, this.options.lang));
