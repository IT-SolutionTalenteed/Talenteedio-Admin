  ...
  (function (e, t) {
          ...
          Object.defineProperty(a, '_fromString', {
            ...
            value: function (e) {
              ...
              for (i = 0; i < a.length; i++)
                (s = a[i].split('=')), this.append(n(s[0]), s.length > 1 ? n(s[1]) : '');
            }
          });
    })(
      void 0 !== e
    ...
    function N(e = {}, ...t) {
      ...
      return A.object(i)
        ? (Object.keys(i).forEach((t) => {
            A.object(i[t])
              ? (Object.keys(e).includes(t) || Object.assign(e, { [t]: {} }), N(e[t], i[t]))
    ...
    const Me = {
      ...
      createButton(e, t) {
        ...
        return (
          ...
          I(a, i),
          'play' === s
            ? (A.array(this.elements.buttons[s]) || (this.elements.buttons[s] = []),
      ...
      setQualityMenu(e) {
        ...
        A.array(e) &&
          (this.options.quality = ne(e).filter((e) => this.config.quality.options.includes(e)));
            ...
            if (
              ...
              if (
                ((A.element(t) && c.contains(t)) ||
                  ((t = O('div', N({}, u, { class: `${u.class} plyr__volume`.trim() }))),
    ...
    const Ne = {
        ...
        update() {
          ...
          this.isHTML5 &&
            ...
            this.elements &&
              F(this.elements.container, this.config.classNames.captions.enabled, !A.empty(e)),
            A.array(this.config.controls) &&
              this.config.controls.includes('settings') &&
              this.config.settings.includes('captions') &&
              Me.setCaptionsMenu.call(this);
    ...
    function ze(e) {
      e && !this.embed.hasPlayed && (this.embed.hasPlayed = !0),
        this.media.paused === e &&
          ((this.media.paused = !e), ee.call(this, this.media, e ? 'play' : 'pause'));
    }
    const Ke = {
      setup() {
        const e = this;
            ...
            events: {
                ...
                (e.options.speed = o.filter((t) => e.config.speed.options.includes(t))),
                  ...
                  (e.timers.buffering = setInterval(() => {
                    (e.media.buffered = s.getVideoLoadedFraction()),
                      ...
                      1 === e.media.buffered &&
                        (clearInterval(e.timers.buffering), ee.call(e, e.media, 'canplaythrough'));
                  }, 200)),
              ...
              onStateChange(i) {
                ...
                switch (
                  ...
                  case 0:
                    Ye.call(e, !1),
                      e.media.loop ? (s.stopVideo(), s.playVideo()) : ee.call(e, e.media, 'ended');
                    break;
                  case 1:
      ...
      constructor(e) {
        t(this, 'load', () => {
          ...
          t(
            ...
            'on',
            (e, t) => (
              A.array(this.events[e]) || (this.events[e] = []), this.events[e].push(t), this
            )
          ),
    ...
    class nt {
      constructor(e, i) {
        if (
          ...
          t(this, 'pause', () =>
            this.playing && A.function(this.media.pause) ? this.media.pause() : null
          ),
          t(this, 'togglePlay', (e) =>
        ...
        (this.supported = Y.check(this.type, this.provider)),
          this.supported.api
            ? ((this.eventListeners = []),
              ...
              A.element(this.elements.container) ||
                ((this.elements.container = O('div')), _(this.media, this.elements.container)),
      ...
      set quality(e) {
        ...
        if (!i.length) return;
        let s = [!A.empty(e) && Number(e), this.storage.get('quality'), t.selected, t.default].find(
            A.number
          ),
          n = !0;
        if (!i.includes(s)) {
