            ...
            if ('[object Array]' === Object.prototype.toString.call(e))
              for (var s = 0; s < e.length; s++) {
                ...
                if ('[object Array]' !== Object.prototype.toString.call(r) && 2 === r.length)
                  throw new TypeError(
                    'Expected [string, any] as entry at index ' + s + " of URLSearchParams's input"
                  );
                this.append(r[0], r[1]);
              }
      ...
      Object.defineProperty(r, '_fromString', {
        ...
        value: function (e) {
          ...
          for (i = 0; i < r.length; i++)
            (s = r[i].split('=')), this.append(n(s[0]), s.length > 1 ? n(s[1]) : '');
        }
      });
})(
          ...
          var t = e.URL,
            i = function (t, i) {
              ...
              if (i && (void 0 === e.location || i !== e.location.href)) {
                (i = i.toLowerCase()),
                  ((s = (n = document.implementation.createHTMLDocument('')).createElement(
                    'base'
                  )).href = i),
              ...
              if (
                ((a.type = 'url'),
                (a.value = t),
                ':' === r.protocol || !/:/.test(r.href) || (!a.checkValidity() && !i))
              )
          ...
          value: function (t) {
            ...
            if (
              (is$1.empty(t) || is$1.string(t)
                ? (s = Array.from(
                    document.querySelectorAll(is$1.string(t) ? t : 'input[type="range"]')
                  ))
                : is$1.element(t)
                ? (s = [t])
                : is$1.nodeList(t)
...
function ready() {
  return new Promise((e) =>
    this.ready ? setTimeout(e, 0) : on.call(this, this.elements.container, 'ready', e)
  ).then(() => {});
}
...
const controls = {
    ...
    return (
      n.toggle
        ? (r.appendChild(controls.createIcon.call(this, n.iconPressed, { class: 'icon--pressed' })),
          ...
          r.appendChild(
            controls.createLabel.call(this, n.labelPressed, { class: 'label--pressed' })
          ),
      ...
      setAttributes(r, i),
      'play' === s
        ? (is.array(this.elements.buttons[s]) || (this.elements.buttons[s] = []),
  ...
  createRange(e, t) {
    ...
    return (
      (this.elements.inputs[e] = i), controls.updateRangeFill.call(this, i), RangeTouch.setup(i), i
    );
  },
  createProgress(e, t) {
    const i = createElement(
          ...
          ' ' !== i.key &&
            ('ArrowDown' === i.key || (s && 'ArrowRight' === i.key)
              ...
              : ((t = e.previousElementSibling),
                is.element(t) || (t = e.parentNode.lastElementChild)),
  ...
  setQualityMenu(e) {
    ...
    is.array(e) &&
      (this.options.quality = dedupe(e).filter((e) => this.config.quality.options.includes(e)));
  ...
  showMenuPanel(e = '', t = !1) {
    ...
    if (support.transitions && !support.reducedMotion) {
      ...
      on.call(this, s, transitionEndEvent, t),
    ...
    return (
      dedupe(is.array(this.config.controls) ? this.config.controls : []).forEach((a) => {
        ...
        if (
          ...
          if (
            ((is.element(t) && c.contains(t)) ||
              ((t = createElement(
                'div',
                extend({}, u, { class: `${u.class} plyr__volume`.trim() })
              )),
        ...
        if (
          ...
          'settings' === a && !is.empty(this.config.settings))
        ) {
          const s = createElement(
            'div',
            extend({}, u, { class: `${u.class} plyr__menu`.trim(), hidden: '' })
          );
          s.appendChild(
            ...
            this.config.settings.forEach((i) => {
              ...
              u.appendChild(createElement('span', { 'aria-hidden': !0 }, i18n.get(i, this.config))),
                ...
                on.call(
                  ...
                  (e) => {
                    'ArrowLeft' === e.key &&
                      (e.preventDefault(), e.stopPropagation(), l.call(this, 'home', !0));
                  },
                  !1
                ),
        ...
        if (
          ...
          !is.url(t) &&
            this.isEmbed &&
            extend(e, { icon: `logo-${this.provider}`, label: this.provider }),
  ...
  inject() {
    ...
    if ((browser.isEdge && repaint(s), this.config.tooltips.controls)) {
      ...
      Array.from(s).forEach((e) => {
        toggleClass(e, this.config.classNames.hidden, !1),
          toggleClass(e, this.config.classNames.tooltip, !0);
      });
    }
  },
  setMediaMetadata() {
  ...
  setMarkers() {
    ...
    i.forEach((e) => {
      ...
      s.appendChild(n),
      this.config.tooltips.seek ||
        ((r = createElement('span', { class: this.config.classNames.tooltip }, '')),
        s.appendChild(r)),
    ...
    update() {
      ...
      this.isHTML5 &&
        ...
        ((r && this.language !== i) || !e.includes(n)) &&
          (captions.setLanguage.call(this, i), captions.toggle.call(this, t && r)),
        this.elements &&
          toggleClass(
  ...
  constructor(e) {
    _defineProperty$1(this, 'onChange', () => {
      ...
      (this.player.elements.fullscreen =
        ...
        closest$1(this.player.elements.container, e.config.fullscreen.container)),
      on.call(
        this.player,
        document,
  ...
  static get prefix() {
    ...
    return (
      ['webkit', 'moz', 'ms'].some(
        (t) =>
          !(
            !is.function(document[`${t}ExitFullscreen`]) &&
            !is.function(document[`${t}CancelFullScreen`])
          ) && ((e = t), !0)
      ),
      e
    );
    ...
    _defineProperty$1(this, 'firstTouch', () => {
      ...
      _defineProperty$1(this, 'global', (e = !0) => {
        ...
        t.config.keyboard.global &&
          toggleListener.call(t, window, 'keydown keyup', this.handleKey, e, !1),
      ...
      _defineProperty$1(this, 'container', () => {
        ...
        !t.keyboard.global &&
          t.keyboard.focused &&
          on.call(e, i.container, 'keydown keyup', this.handleKey, !1),
          on.call(
            e,
            i.container,
            ...
            (t) => {
              ...
              ['touchstart', 'touchmove', 'mousemove'].includes(t.type) &&
                (ui.toggleControls.call(e, !0), (r = e.touch ? 3e3 : 2e3)),
      ...
      _defineProperty$1(this, 'media', () => {
        ...
        if (
          ...
          on.call(e, e.media, 'durationchange loadeddata loadedmetadata', (t) =>
            controls.durationUpdate.call(e, t)
          ),
          on.call(e, e.media, 'ended', () => {
            e.isHTML5 && e.isVideo && e.config.resetOnEnd && (e.restart(), e.pause());
          }),
          on.call(e, e.media, 'progress playing seeking seeked', (t) =>
            controls.updateProgress.call(e, t)
          ),
          on.call(e, e.media, 'volumechange', (t) => controls.updateVolume.call(e, t)),
          on.call(e, e.media, 'playing play pause ended emptied timeupdate', (t) =>
            ui.checkPlaying.call(e, t)
          ),
      ...
      _defineProperty$1(this, 'controls', () => {
        ...
        this.bind(
          ...
          this.bind(t.progress, 'mouseenter mouseleave mousemove', (t) =>
            controls.updateSeekTooltip.call(e, t)
          ),
          ...
          e.config.toggleInvert &&
            ...
            this.bind(t.display.currentTime, 'click', () => {
              0 !== e.currentTime &&
                ((e.config.invertTime = !e.config.invertTime), controls.timeUpdate.call(e));
            }),
          this.bind(
            t.inputs.volume,
            i,
          ...
          this.bind(t.controls, 'focusin', () => {
            ...
            clearTimeout(s.controls),
              (s.controls = setTimeout(() => ui.toggleControls.call(e, !1), n));
          }),
          this.bind(
            t.inputs.volume,
            'wheel',
...
function assurePlaybackState$1(e) {
  e && !this.embed.hasPlayed && (this.embed.hasPlayed = !0),
    this.media.paused === e &&
      ((this.media.paused = !e), triggerEvent.call(this, this.media, e ? 'play' : 'pause'));
}
const vimeo = {
  setup() {
    const e = this;
  ...
  constructor(e) {
    _defineProperty$1(this, 'load', () => {
      ...
      _defineProperty$1(
        this,
        'on',
        (e, t) => (is.array(this.events[e]) || (this.events[e] = []), this.events[e].push(t), this)
      ),
...
class Plyr {
  constructor(e, t) {
    if (
      ...
      _defineProperty$1(this, 'togglePlay', (e) =>
        (is.boolean(e) ? e : !this.playing) ? this.play() : this.pause()
      ),
  ...
  set quality(e) {
    ...
    if (!i.length) return;
    let s = [!is.empty(e) && Number(e), this.storage.get('quality'), t.selected, t.default].find(
        is.number
      ),
      n = !0;
    if (!i.includes(s)) {
  ...
  set poster(e) {
    this.isVideo
      ? ui.setPoster.call(this, e, !1).catch(() => {})
  ...
  set pip(e) {
    ...
    is.function(this.media.webkitSetPresentationMode) &&
      this.media.webkitSetPresentationMode(t ? pip.active : pip.inactive),
