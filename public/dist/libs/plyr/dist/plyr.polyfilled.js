  ...
  (function (global, factory) {
    ...
    const controls = {
      ...
      checkMenu() {
        ...
        const visible =
          !is.empty(buttons) && Object.values(buttons).some((button) => !button.hidden);
    ...
    class Fullscreen {
      constructor(player) {
        ...
        this.player.elements.fullscreen =
          ...
          closest$1(this.player.elements.container, player.config.fullscreen.container);
    ...
    const vimeo = {
      ...
      ready() {
        ...
        Promise.all([player.embed.getVideoWidth(), player.embed.getVideoHeight()]).then(
          (dimensions) => {
    ...
    class Ads {
      ...
      constructor(player) {
        ...
        _defineProperty$1(this, 'onAdsManagerLoaded', (event) => {
          ...
          this.manager.addEventListener(google.ima.AdErrorEvent.Type.AD_ERROR, (error) =>
            this.onAdError(error)
          );
    ...
    class PreviewThumbnails {
      ...
      constructor(player) {
          ...
          if (event.type === 'touchmove') {
            ...
            const point =
              ...
              _this$player$config$m === void 0
                ? void 0
                : (_this$player$config$m2 = _this$player$config$m.points) === null ||
                  _this$player$config$m2 === void 0
                ? void 0
        ...
        _defineProperty$1(
          this,
          'showImage',
          (previewImage, frame, qualityIndex, thumbNum, thumbFilename, newImage = true) => {
