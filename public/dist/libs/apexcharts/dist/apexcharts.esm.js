          ...
          value: function (t) {
            ...
            if (a && 'object' === i(a)) {
              ...
              (p =
                ...
                ((null !==
                  (d = (a = this.checkForCatToNumericXAxis(this.chartType, p, a)).chart
                    .sparkline) &&
                  void 0 !== d &&
                  d.enabled) ||
        ...
        },
        {
          ...
          value: function (t) {
            ...
            var S = this.barCtx.series[r][o] < 0,
              C = h;
            switch (
              (this.barCtx.isReversed && ((C = h - g + (S ? 2 * g : 0)), (h -= g)), x.position)
            ) {
              case 'center':
                p = k
                  ? S
            ...
            return (
              s.config.chart.stacked ||
                (p < 0
                  ? (p = 0 + v)
                  : p + u.height / 3 > s.globals.gridHeight && (p = s.globals.gridHeight - v)),
              {
                bcx: c,
                bcy: h,
                dataLabelsX: e,
            ...
            return (
              null != t &&
                (i =
                  ...
                  2 *
                    (this.barCtx.isReversed ? t / this.barCtx.yRatio[this.barCtx.yaxisIndex] : 0)),
              i
            );
          }
        },
          ...
          value: function (t, i) {
            ...
            for (var n = 0, l = 0; n < t.length; n++, l++) {
              ...
              for (
                ...
                this.isHorizontal
                  ? ((T = this.drawBarPaths(
                      e(e({}, M), {}, { barHeight: k, zeroW: g, yDivision: c })
                    )),
                    (A = this.series[n][P] / this.invertedYRatio))
                  : ((T = this.drawColumnPaths(
                      e(e({}, M), {}, { xDivision: h, barWidth: A, zeroH: d })
                    )),
          ...
          value: function (t) {
            ...
            a ||
              (a = this.barOptions.distributed
                ? C.globals.stroke.colors[s]
                : C.globals.stroke.colors[e]),
              C.config.series[r].data[s] &&
                C.config.series[r].data[s].strokeColor &&
                (a = C.config.series[r].data[s].strokeColor),
              this.isNullValue && (i = 'none');
            var P =
                ((s / C.config.chart.animations.animateGradually.delay) *
            ...
            T.count > 0 &&
              ...
              void 0 !== u &&
                void 0 !== p &&
                (I.attr('data-range-y1', u), I.attr('data-range-y2', p)),
            ...
            return (
              null !== M.dataLabels && w.add(M.dataLabels),
      ...
      r(s, [
        ...
        },
        {
          ...
          value: function (t, e, i, a, s, r) {
            ...
            this.isHorizontal
              ? ((o =
                  ((o = a = c.globals.gridHeight / c.globals.dataPoints) *
                    parseInt(c.config.plotOptions.bar.barHeight, 10)) /
                  100),
                null !== (l = c.globals.seriesGroups) &&
                  void 0 !== l &&
                  l.length &&
                  (o /= c.globals.seriesGroups.length),
                -1 === String(c.config.plotOptions.bar.barHeight).indexOf('%') &&
                  (o = parseInt(c.config.plotOptions.bar.barHeight, 10)),
                (r =
              ...
              : ((n = i = c.globals.gridWidth / c.globals.dataPoints),
                ...
                null !== (h = c.globals.seriesGroups) &&
                  void 0 !== h &&
                  h.length &&
                  (n /= c.globals.seriesGroups.length),
          ...
          value: function (t) {
            ...
            if (c.globals.isXNumeric) {
              ...
              p || (p = 0),
                ...
                c.globals.seriesGroups.length &&
                  (i =
                    (p - c.globals.minX) / this.xRatio - (r / 2) * c.globals.seriesGroups.length);
            }
            for (
            ...
            if (
              ...
              for (var L = 1; L < A; L++) {
                ...
                if (
                  (null === (I = this.groupCtx.prevYVal[m - L]) || void 0 === I ? void 0 : I[g]) >=
                  0
                ) {
        ...
        },
        {
          ...
          value: function (t) {
            ...
            for (var M = n, X = 0; X < a; X++) {
              ...
              z
                ? (n =
                    p - T / A[this.yaxisIndex] + 2 * (this.isReversed ? T / A[this.yaxisIndex] : 0))
                : ((n =
                    p -
      ...
      r(t, [
        ...
        },
        {
          ...
          value: function (t, e) {
            ...
            if (s.comboCharts) {
              if (
                (o.series.length > 0 && v.push(p.draw(o.series, 'area', o.i)), h.series.length > 0)
              )
