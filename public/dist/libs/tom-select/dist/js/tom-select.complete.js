...
(function (global, factory) {
  ...
  const isKeyDown = (key_name, evt) => {
    ...
    var count =
      (evt.altKey ? 1 : 0) + (evt.ctrlKey ? 1 : 0) + (evt.shiftKey ? 1 : 0) + (evt.metaKey ? 1 : 0);
    ...
    var init_select = () => {
      ...
      var addGroup = (optgroup) => {
        ...
        optgroup_data[field_optgroup_label] =
          optgroup_data[field_optgroup_label] || optgroup.getAttribute('label') || '';
  ...
  class TomSelect extends MicroPlugin(MicroEvent) {
    ...
    scrollToOption(option, behavior) {
      ...
      const y =
        option.getBoundingClientRect().top - content.getBoundingClientRect().top + scrollTop;
    ...
    inputState() {
      ...
      if (
        ...
        (!self.isFocused && self.settings.hidePlaceholder && self.items.length > 0)
      ) {
    ...
    updateOriginalInput(opts = {}) {
      ...
      if (self.is_select_tag) {
        ...
        function AddSelected(option_el, value, label) {
          if (!option_el) {
            option_el = getDom(
              '<option value="' + escape_html(value) + '">' + escape_html(label) + '</option>'
            );
    ...
    canCreate(input) {
      return (
        this.settings.create && input.length > 0 && this.settings.createFilter.call(this, input)
      );
    }
    /**
