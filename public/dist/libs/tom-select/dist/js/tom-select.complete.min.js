      ...
      for (let t of (function* (e) {
        for (const [t, i] of e)
          for (let e = t; e <= i; e++) {
            ...
            i != t.toLowerCase() &&
              (i.length > 3 ||
                (0 != i.length && (yield { folded: i, composed: t, code_point: e })));
          }
      })(e))
      ...
      return (
        ...
        n.forEach((e) => {
          ...
          o && (i = e.match(o)) && ((n = i[1]), (e = i[2])),
            e.length > 0 &&
              ((l = this.settings.diacritics ? A(e) || null : r(e)), l && t && (l = '\\b' + l)),
    ...
    _getSortFunction(e) {
      ...
      return i.length
        ? function (e, t) {
            var s, n;
            for (let o of i) {
              if (((n = o.field), (s = ('desc' === o.direction ? -1 : 1) * P(r(n, e), r(n, t)))))
                return s;
            }
            return 0;
          }
  ...
  class ue extends (function (e) {
    ...
    onKeyPress(e) {
      ...
      if (!t.isLocked) {
        ...
        return t.settings.create && 'multi' === t.settings.mode && i === t.settings.delimiter
        ...
        switch (e.keyCode) {
          ...
          case 9:
            return void (
              ...
              (t.canSelect(t.activeOption) && (t.onOptionSelect(e, t.activeOption), se(e)),
    ...
    clearActiveOption() {
      this.activeOption &&
        (z(this.activeOption, 'active'), G(this.activeOption, { 'aria-selected': null })),
        (this.activeOption = null),
    ...
    removeItem(e = null, t) {
      ...
      (s = Q(e)),
        e.remove(),
        e.classList.contains('active') &&
          ((n = i.activeItems.indexOf(e)), i.activeItems.splice(n, 1), z(e, 'active')),
        i.items.splice(s, 1),
        (i.lastQuery = null),
      ...
      if (t.is_select_tag) {
        ...
        t.input.querySelectorAll('option:checked').forEach((e) => {
          ...
          0 == t.items.length && 'single' == t.settings.mode
            ...
            : t.items.forEach((n) => {
                if (
                  ((i = t.options[n]), (s = i[t.settings.labelField] || ''), e.includes(i.$option))
                ) {
    ...
    deleteSelection(e) {
      ...
      if (r.activeItems.length)
        (n = K(r.activeItems, t)), (s = Q(n)), t > 0 && s++, E(r.activeItems, (e) => l.push(e));
    ...
    shouldDelete(e, t) {
      ...
      return !(
        !i.length ||
        ('function' == typeof this.settings.onDelete && !1 === this.settings.onDelete(i, t))
      );
    }
