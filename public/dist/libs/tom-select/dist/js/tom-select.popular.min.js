...
!(function (t, e) {
      ...
      for (let e of (function* (t) {
        for (const [e, i] of t)
          for (let t = e; t <= i; t++) {
            ...
            i != e.toLowerCase() &&
              (i.length > 3 ||
                (0 != i.length && (yield { folded: i, composed: e, code_point: t })));
          }
      })(t))
      ...
      return (
        ...
        n.forEach((t) => {
          ...
          o && (i = t.match(o)) && ((n = i[1]), (t = i[2])),
            t.length > 0 &&
              ((l = this.settings.diacritics ? C(t) || null : r(t)), l && e && (l = '\\b' + l)),
    ...
    _getSortFunction(t) {
      ...
      return i.length
        ? function (t, e) {
            var s, n;
            for (let o of i) {
              if (((n = o.field), (s = ('desc' === o.direction ? -1 : 1) * P(r(n, t), r(n, e)))))
                return s;
            }
            return 0;
          }
  ...
  const X = (t) => (null == t ? null : Y(t)),
    ...
    nt = (t, e) =>
      !!e &&
      !!e[t] &&
      1 === (e.altKey ? 1 : 0) + (e.ctrlKey ? 1 : 0) + (e.shiftKey ? 1 : 0) + (e.metaKey ? 1 : 0),
    ot = (t, e) => {
  ...
  class dt extends (function (t) {
      ...
      class extends t {
        ...
        initializePlugins(t) {
          ...
          if (Array.isArray(t))
            ...
            for (e in t) t.hasOwnProperty(e) && ((s.plugins.settings[e] = t[e]), n.push(e));
    ...
    constructor(t, e) {
      ...
      (s.tomselect = this),
        (i = (window.getComputedStyle && window.getComputedStyle(s, null)).getPropertyValue(
          'direction'
        ));
      const n = at(s, e);
      (this.settings = n),
      ...
      'function' != typeof o &&
        ...
        o instanceof RegExp
          ...
          : (n.createFilter = (t) => this.settings.duplicates || !this.options[t])),
    ...
    setupTemplates() {
      var t = this,
        ...
        s = {
          ...
          option_create: (t, e) =>
            '<div class="create">Add <strong>' + e(t.input) + '</strong>&hellip;</div>',
    ...
    onKeyPress(t) {
      ...
      if (!e.isLocked) {
        ...
        return e.settings.create && 'multi' === e.settings.mode && i === e.settings.delimiter
        ...
        switch (t.keyCode) {
          ...
          case 9:
            return void (
              ...
              (e.canSelect(e.activeOption) && (e.onOptionSelect(t, e.activeOption), it(t)),
    ...
    clearActiveOption() {
      this.activeOption &&
        (H(this.activeOption, 'active'), Q(this.activeOption, { 'aria-selected': null })),
        (this.activeOption = null),
    ...
    removeOptionGroup(t) {
      this.optgroups.hasOwnProperty(t) &&
        (delete this.optgroups[t], this.clearCache(), this.trigger('optgroup_remove', t));
    }
    clearOptionGroups() {
    ...
    removeItem(t = null, e) {
      ...
      (s = K(t)),
        t.remove(),
        t.classList.contains('active') &&
          ((n = i.activeItems.indexOf(t)), i.activeItems.splice(n, 1), H(t, 'active')),
        i.items.splice(s, 1),
        (i.lastQuery = null),
      ...
      if (e.is_select_tag) {
        ...
        e.input.querySelectorAll('option:checked').forEach((t) => {
          ...
          0 == e.items.length && 'single' == e.settings.mode
            ...
            : e.items.forEach((n) => {
                if (
                  ((i = e.options[n]), (s = i[e.settings.labelField] || ''), t.includes(i.$option))
                ) {
    ...
    deleteSelection(t) {
      ...
      if (r.activeItems.length)
        (n = B(r.activeItems, e)), (s = K(n)), e > 0 && s++, E(r.activeItems, (t) => l.push(t));
    ...
    shouldDelete(t, e) {
      ...
      return !(
        !i.length ||
        ('function' == typeof this.settings.onDelete && !1 === this.settings.onDelete(i, e))
      );
    }
