<template>
  <PageHeader title="Dashboard" page="Dashboard" />
      ...
      <div class="col-sm-6 col-lg-3">
        <div class="card">
          <div class="card-body">
            ...
            <div class="d-flex align-items-baseline">
              <div class="h1 mb-4 me-2">6,782</div>
              <div class="me-auto">
      ...
      <div class="col-sm-6 col-lg-3">
        <div class="card">
          <div class="card-body">
            ...
            <div class="d-flex align-items-baseline">
              <div class="h1 mb-4 me-2">2,986</div>
              <div class="me-auto">
                <span class="text-green d-inline-flex align-items-center lh-1">
                  4%
                  <!-- Download SVG icon from http://tabler-icons.io/i/trending-up -->
      ...
      <div class="col-lg-6">
        <div class="row row-cards">
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                <p class="mb-4">Using Storage <strong>6854.45 MB </strong>of 8 GB</p>
...
await loadscript({ src: '/dist/libs/apexcharts/dist/apexcharts.min.js?1684106062' });
await loadscript({ src: '/dist/libs/jsvectormap/dist/js/jsvectormap.min.js?1684106062' });
loadscript({ src: '/dist/libs/jsvectormap/dist/maps/world.js?1684106062' });
loadscript({ src: '/dist/libs/jsvectormap/dist/maps/world-merc.js?1684106062' });

onMounted(() => {
  loadscript({ src: '/dist/js/dashboard/script.js' });
});
</script>
